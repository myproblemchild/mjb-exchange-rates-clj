...
(def url-template
  "https://sheets.googleapis.com/v4/spreadsheets/%s/values/Sheet1!A1:B?key=%s")
...
(defn make-exchange-rates-map [fetched-exchange-pairs]
  (->>
   ...
   ;;like [["USD" "116.4192"] ["EUR" "129.2423"] ["GBP" "152.5809"] ... ]
   fetched-exchange-pairs

   ;; Flattens the pairs into
   ;; [["USD" "116.4192" "EUR" "129.2423" "GBP" "152.5809" ... ]]
   flatten

   ;; Creates a rates map
   ;; like {"SGD" "85.8865", "AUD" "86.9514", "EUR" "129.2423" ... }
    (apply hash-map)
 )
)
